...
public abstract class ConfigUtil {
    ...
    private volatile static SharedPreferences.Editor editor = null;
    ...
    public static SharedPreferences getPreferences(Context context) {
        if (preferences == null) {
            preferences = context.getSharedPreferences(context.getPackageName() + "_preferences.config", Context.MODE_PRIVATE);
        }
        return preferences;
    }
